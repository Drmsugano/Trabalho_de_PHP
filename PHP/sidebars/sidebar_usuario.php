    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="../listas/listar_usuarios.php">Listas de Usuarios</a></li>
          <li><a href='../listas/listar_produtos.php'>Listas de Produtos</a></li>
          <li><a href='../listas/listar_clientes.php'>Listas de Clientes</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="../produtos/catalogo.php">Explorar</a></li>
        </ul>
      </li>
      <li>
      <li>
