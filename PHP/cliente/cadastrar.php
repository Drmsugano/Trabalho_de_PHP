...
$verifica_grupo = mysqli_query($conexao, "select * from grupocliente");
if (mysqli_fetch_array($verifica_grupo) == 0) { ?>
    <script>alert("Cadastre um Grupo Primeiro para Cadastrar um cliente")</script>
    <?php header("refresh: 0.5 ../grupos/cadastrarGrupoCliente.php");
}
...
if (isset($_POST['mysql'])) {
    ...
    if (mysqli_fetch_array($result_email) > 0) {
        ...
        $sql = mysqli_query($conexao, "insert into cliente (nome, email, png_cliente,id_grupo_cliente, telefone, cep, endereco, numero, status, cpfcnpj, id_estado, id_cidade) values ('$nome', '$email', '$diretorio','$grupo','$telefone','$cep','$endereco','$numero','$status','$cpfcnpj','$estado','$cidade')") or die("Falha na Execução 3");
        $mensagem = "<br><div class='alert alert-primary' role='alert'>O cliente " . $nome . " foi cadastrado com sucesso.</div>";
    }
}
?>
<!DOCTYPE html>
    ...
    <section class="home-section">
        ...
        <div class="container">
            <form method='post' enctype="multipart/form-data">
                <br>
                <h1 class="h3 mb-3 fw-normal">Insira os dados para o cadastro do Cliente</h1>
                <div class="mb-3">
                    <label for="floatingInput">Foto do Cliente</label>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col">
                            <select class="form-select" name="grupo" aria-label="select example"
                                placeholder="Grupo de Usuario" required>
