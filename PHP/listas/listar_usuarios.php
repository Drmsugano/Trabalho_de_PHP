...
$sql = "select *, grupousuario.nome_grupo from usuario inner join grupousuario on grupousuario.id_grupo_usuario = usuario.id_grupo_usuario";
...
if (isset($_GET["id"])) { ?>
  ...
  <?php
  header('refresh:0.5 listar_usuarios.php');
} ?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body>
  ...
  <section class="home-section">
    ...
    <div class=" mb-3 container">
      <div class="card">
        <div class="card-body">
          <h5>Listagem de Usuários <a href="../usuario/cadastrar.php" class="btn btn-primary">+</a></h5>
        </div>
      </div>
        ...
        <tbody>
          <?php while ($linhas = mysqli_fetch_array($resultado)) { ?>
            <tr>
              ...
              <td><img src=../../<?= $linhas['png_perfil'] ?> width='50' height='50'></td>
              <td>
                <a href='../usuario/alterar.php?id=<?= $linhas['id_usuario'] ?>' class='btn btn-warning'>
                  ...
                  <a href='listar_usuarios.php?id=<?= $linhas['id_usuario'] ?>' class='m-1 btn btn-danger'
