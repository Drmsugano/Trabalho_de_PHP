...
if (isset($_POST["sql"])) {
  $nome = $_POST["nome"];
  $sql = "insert into grupousuario (nome_grupo) values ('$nome')";
...
<body>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text">Cadastrar Grupo de Usuario</span>
    </div>
    <div class="container">
      <form method='post' enctype="multipart/form-data">
        <br>
        <h4 class="h4 mb-3 fw-normal">Insira os dados para o cadastro do grupo de Usuarios</h4>
        <div class="mb-3">
